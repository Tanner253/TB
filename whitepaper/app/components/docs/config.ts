...
export const MISSION_BODY =
  'Creator fees become real buys on the chart and airdrops to the most underwater holders — every cycle, on autopilot. This whitepaper is the technical reference for how it all works.'
