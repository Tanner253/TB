    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-3 sm:px-5 py-6 sm:py-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            <p className="text-sol-purple text-xs font-semibold uppercase tracking-[0.14em] mb-2">Explore</p>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Token catalog</h1>
            <p className="text-sm text-ink-3 mt-1">
              Live reward sessions — sort by pot, on-chart Gen volume, or total paid out
            </p>
          </div>
          <Link
            href="/launch"
