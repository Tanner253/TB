...
const BODY = '#d4fc50'
const BODY_DARK = '#a9cf33'
const BODY_DEEP = '#7a9a1f'
const INKFACE = '#1b2408'
...
const DEFS = `
  <defs>
    ...
    <linearGradient id="gy" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#fcffee"/>
      <stop offset="100%" stop-color="#e9f6c6"/>
    </linearGradient>
...
const SHADING = `<g clip-path="url(#gc)">
    ...
    <path d="M40 168 C96 180 168 182 232 168" stroke="#a9cf33" stroke-opacity="0.55" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M56 180 C110 190 172 190 224 180" stroke="#a9cf33" stroke-opacity="0.4" stroke-width="3" fill="none" stroke-linecap="round"/>
...
const SPOUT = `<g>
    <path d="M136 44 C134 32 126 28 126 16" stroke="#bfe4f5" stroke-width="6" fill="none" stroke-linecap="round" opacity="0.9"/>
    <path d="M146 42 C148 32 154 28 154 18" stroke="#bfe4f5" stroke-width="6" fill="none" stroke-linecap="round" opacity="0.9"/>
...
export const WHALE_ROCKET_SVG = svg(
  ...
  <g transform="rotate(-8 160 204)">
    ...
    <circle cx="150" cy="204" r="13" fill="#1b2408" stroke="#e2e8f0" stroke-width="5"/>
