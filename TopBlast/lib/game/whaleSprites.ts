...
const DEFS = `
  <defs>
    ...
    <linearGradient id="gf" x1="0" y1="0" x2="0" y2="1">
      ...
      <stop offset="55%" stop-color="#fdb022"/>
      <stop offset="100%" stop-color="#ff6a3d"/>
    </linearGradient>
    <radialGradient id="gr">
      <stop offset="0%" stop-color="#ff9d8a" stop-opacity="0.9"/>
...
const SHADING = `<g clip-path="url(#gc)">
    ...
    <path d="M40 168 C96 180 168 182 232 168" stroke="#7A2FD4" stroke-opacity="0.55" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M56 180 C110 190 172 190 224 180" stroke="#7A2FD4" stroke-opacity="0.4" stroke-width="3" fill="none" stroke-linecap="round"/>
...
const SPOUT = `<g>
    <path d="M136 44 C134 32 126 28 126 16" stroke="#cfe8ff" stroke-width="6" fill="none" stroke-linecap="round" opacity="0.9"/>
    <path d="M146 42 C148 32 154 28 154 18" stroke="#cfe8ff" stroke-width="6" fill="none" stroke-linecap="round" opacity="0.9"/>
    <circle cx="123" cy="10" r="4.5" fill="#e7f3ff"/>
    <circle cx="157" cy="12" r="4" fill="#e7f3ff"/>
    <circle cx="140" cy="5" r="5" fill="#cfe8ff"/>
  </g>`
...
export const WHALE_ROCKET_SVG = svg(
  ...
  <g transform="rotate(-8 160 204)">
    <path d="M240 186 C278 190 302 199 316 204 C302 209 278 218 240 222 Z" fill="#fdb022" opacity="0.9"/>
    <path d="M240 193 C268 196 288 200 300 204 C288 208 268 212 240 215 Z" fill="#ffee7a"/>
    ...
    <path d="M102 182 C76 189 62 197 55 204 C62 211 76 219 102 226 Z" fill="#9945FF"/>
    <path d="M230 184 C244 171 257 165 268 164 C262 175 258 183 255 191 Z" fill="#9945FF"/>
    <path d="M230 224 C244 237 257 243 268 244 C262 233 258 225 255 217 Z" fill="#9945FF"/>
    <rect x="198" y="183" width="6" height="42" fill="#3f3f46" opacity="0.7"/>
    <circle cx="150" cy="204" r="13" fill="#2b2140" stroke="#e2e8f0" stroke-width="5"/>
